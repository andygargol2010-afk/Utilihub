...
if (bankStart < 0 || openBrace < 0) throw new Error("No se pudo localizar el inicio del BANK.");
...
const shuffleStart = source.indexOf("function shuffle");
if (shuffleStart < 0 || shuffleStart <= closeBrace) throw new Error("No se pudo localizar la sección de utilidades del motor.");
