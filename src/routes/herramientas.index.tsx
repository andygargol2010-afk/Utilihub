...
export const Route = createFileRoute("/herramientas/")({
  head: () => ({
    ...
    scripts: [{ type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "CollectionPage", name: "All free online tools", url: absoluteUrl("/herramientas"), numberOfItems: ALL_TOOLS.length, isPartOf: { "@type": "WebSite", name: "UtiliHub", url: absoluteUrl("/") } }) }],
  }),
