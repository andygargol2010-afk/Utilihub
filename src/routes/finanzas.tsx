...
export const Route = createFileRoute("/finanzas")({
  head: () => ({ meta: [{ title: "Online financial calculators | UtiliHub" }, { name: "description", content: "Free financial calculators for investing, loans, savings, inflation, portfolios, retirement, and fixed income." }] }),
