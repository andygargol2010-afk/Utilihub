...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><SiteHeader /><CommandPalette /><main><Outlet /></main><SiteFooter /><Analytics /><SpeedInsights /></QueryClientProvider>;
}
