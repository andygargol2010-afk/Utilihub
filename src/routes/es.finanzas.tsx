...
export const Route = createFileRoute("/es/finanzas")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: absoluteUrl("/es/finanzas") }, { rel: "alternate", hrefLang: "es", href: absoluteUrl("/es/finanzas") }, { rel: "alternate", hrefLang: "en", href: absoluteUrl("/finance") }, { rel: "alternate", hrefLang: "x-default", href: absoluteUrl("/finance") }],
  }),
...
function SpanishFinanceIndex() {
  ...
  if (pathname !== "/es/finanzas") return <Outlet />;
