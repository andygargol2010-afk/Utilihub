    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@graph": [
          ...
          breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Hubs", path: "/hubs/documentos-y-archivos" }, { name: DOCUMENT_HUB.name }]),
          faqSchema([
