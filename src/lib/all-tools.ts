...
if(duplicateSlugs.length&&import.meta.env.DEV)console.warn("UtiliHub: duplicate catalog slugs detected:",duplicateSlugs);
...
export const ALL_TOOLS:CatalogTool[]=uniqueBySlug(catalogSources);
...
export const toolHref=(tool:Pick<CatalogTool,"slug"|"category">)=>tool.category==="finanzas"?`/finanzas/${tool.slug}`:`/herramientas/${tool.slug}`;
