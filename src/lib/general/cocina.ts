...
export const COCINA_TOOLS=[
 ...
 c("conversion-gramos-tazas","Cooking grams to cups","number","Convert approximate amounts of common ingredients between grams and cups.",{operation:"divide",fields:["Grams","g/cup factor"]}),
 ...
 c("coste-por-porcion-cocina","Recipe cost per serving","number","Calculate the cost of one recipe serving.",{operation:"divide",fields:["Total cost","Servings"]}),
 ...
 c("porcentaje-merma-cocina","Cooking waste percentage","number","Calculate what percentage of an ingredient is lost during preparation.",{operation:"percent-of",fields:["Waste","Initial amount"]}),
