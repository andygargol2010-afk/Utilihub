...
export const MATH_ADVANCED_TOOLS=[
 ...
 t("media-armonica","Media armónica","Calcula la media armónica de una lista de valores positivos o negativos no nulos.",["Datos"],"harmonic-mean"),
 ...
 t("distribucion-poisson","Distribución de Poisson","Calcula la probabilidad de observar k eventos con tasa media λ.",["k eventos","Valor no usado","λ"],"poisson"),
 t("puntuacion-t","Puntuación T","Calcula una puntuación T a partir de un valor, media y desviación estándar.",["Valor","Media","Desviación estándar"],"t-score"),
 ...
 t("interpolacion-lineal","Interpolación lineal","Estima y para un valor x entre dos puntos conocidos.",["x","x1","x2","y1","y2"],"linear-interpolation"),
];
