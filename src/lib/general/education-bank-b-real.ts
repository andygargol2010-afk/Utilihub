...
export const MAPAS:Q[]=[
 q("¿Qué representa una escala cartográfica?",["La relación entre una distancia del mapa y la distancia real","La altitud máxima","La temperatura media","La edad del mapa"],"La relación entre una distancia del mapa y la distancia real",["universidad"],"dificil"),
 ...
 q("¿Qué indican las curvas de nivel en un mapa topográfico?",["Puntos de igual altitud","Puntos de igual población","Fronteras políticas","Direcciones del viento"],"Puntos de igual altitud",["universidad"],"media"),
 q("¿Qué coordenada geográfica mide la distancia angular al norte o sur del ecuador?",["Latitud","Longitud","Altitud","Escala"],"Latitud",["universidad"],"facil"),
 ...
 q("¿Qué sucede al aumentar el denominador de una escala 1:n?",["Se representa una superficie mayor con menos detalle","Aumenta el detalle automáticamente","Desaparecen las coordenadas","La escala deja de ser numérica"],"Se representa una superficie mayor con menos detalle",["universidad"],"dificil"),
 q("Si 1 cm en un mapa representa 5 km, ¿cuántos km representan 4 cm?",["20 km","9 km","25 km","1,25 km"],"20 km",["primaria"],"facil"),
 ...
 q("¿Qué representan normalmente los símbolos convencionales de un mapa?",["Elementos o fenómenos mediante signos gráficos","Solo montañas","Solo fronteras","Solo carreteras"],"Elementos o fenómenos mediante signos gráficos",["primaria"],"media"),
 ...
 q("¿Qué es un meridiano?",["Una línea imaginaria que une los polos","Una línea paralela al ecuador","Una frontera política","Una curva de nivel"],"Una línea imaginaria que une los polos",["primaria"],"facil"),
 ...
 q("¿Qué ventaja tiene un globo terráqueo frente a un mapa plano?",["Reduce ciertas deformaciones de la forma global de la Tierra","Siempre muestra más detalle","No necesita escala","Elimina las coordenadas"],"Reduce ciertas deformaciones de la forma global de la Tierra",["secundaria"],"dificil"),
 q("¿Qué problema aparece al representar una esfera sobre una superficie plana?",["Deformaciones","Aumento de la gravedad","Pérdida de la atmósfera","Cambio de estaciones"],"Deformaciones",["secundaria"],"dificil"),
 ...
 q("¿Qué mapa sería más adecuado para estudiar una ruta de transporte entre ciudades?",["Mapa vial","Mapa geológico","Mapa climático","Mapa de vegetación"],"Mapa vial",["primaria"],"facil"),
 q("¿Qué mapa sería más adecuado para analizar la distribución de tipos de suelo?",["Mapa edafológico","Mapa político","Mapa vial","Mapa horario"],"Mapa edafológico",["universidad"],"media"),
 ...
 q("¿Qué significa una escala 1:100000?",["1 unidad en el mapa equivale a 100000 unidades reales","100000 unidades del mapa equivalen a 1 real","1 km equivale siempre a 100000 km","El mapa no tiene escala"],"1 unidad en el mapa equivale a 100000 unidades reales",["universidad"],"dificil"),
 q("En una escala 1:50000, ¿qué distancia real representa 2 cm?",["1 km","100 km","250 m","2,5 km"],"1 km",["secundaria"],"dificil"),
 ...
 q("¿Qué representa la altitud de un punto?",["Su altura respecto de un nivel de referencia","Su distancia al ecuador","Su longitud geográfica","Su población"],"Su altura respecto de un nivel de referencia",["primaria"],"facil"),
