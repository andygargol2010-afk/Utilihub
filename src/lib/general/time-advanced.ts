...
export const TIME_ADVANCED_TOOLS=[
 ...
 t("edad-exacta","Edad exacta","Calcula años, meses y días transcurridos desde una fecha de nacimiento.",["Fecha de nacimiento","Fecha de referencia"],"exact-age"),
 t("dias-entre-fechas","Días entre fechas","Calcula el número de días entre dos fechas.",["Fecha inicial","Fecha final"],"days-between"),
 t("dia-semana","Día de la semana","Determina qué día de la semana corresponde a una fecha.",["Fecha"],"weekday"),
 t("semana-del-ano","Semana del año","Calcula el número de semana ISO de una fecha.",["Fecha"],"week-number"),
 t("dias-del-mes","Número de días de un mes","Indica cuántos días tiene un mes de un año determinado.",["Mes","Año"],"days-in-month"),
 t("dias-laborables","Días laborables entre fechas","Cuenta los días de lunes a viernes entre dos fechas.",["Fecha inicial","Fecha final"],"business-days"),
