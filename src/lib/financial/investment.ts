...
export const INVESTMENT_TOOLS: FinancialDefinition[] = [
  {
    slug: "cagr",
    fields: [
      f("start", "Capital inicial", 10000, "$"),
      f("end", "Valor final", 15000, "$"),
      f("years", "Años", 5),
    ],
    calculate: (v) => {
  ...
  },
  {
    slug: "roi",
    fields: [
      f("cost", "Coste inicial", 10000, "$"),
      f("end", "Valor final", 12500, "$"),
  ...
  },
  {
    ...
    fields: [
      f("cost", "Capital invertido", 10000, "$"),
      f("fees", "Costes totales", 100, "$"),
      f("price", "Precio actual por unidad", 50, "$"),
  ...
  },
  {
    ...
    fields: [
      f("q1", "Cantidad compra 1", 100),
      f("p1", "Precio compra 1", 20, "$"),
      f("q2", "Cantidad compra 2", 50),
      f("p2", "Precio compra 2", 15, "$"),
      f("q3", "Cantidad compra 3", 0),
    ...
    calculate: (v) => {
      ...
      return [
        ...
        { label: "Precio medio", value: money(total / q) },
      ];
    },
  },
  {
    slug: "dca",
    fields: [
      f("initial", "Capital inicial", 1000, "$"),
      f("monthly", "Aporte mensual", 300, "$"),
      f("rate", "Rentabilidad anual estimada", 8, "%"),
      f("years", "Años", 10),
    ],
    calculate: (v) => {
      ...
      return [
        ...
        { label: "Crecimiento", value: money(fv - contributed) },
      ];
    },
  },
  {
    ...
    calculate: (v) => {
      ...
      return [
        { label: "Riesgo", value: money(risk) },
        { label: "Beneficio potencial", value: money(reward) },
        { label: "Ratio riesgo/beneficio", value: `1:${money(reward / risk)}` },
      ];
    },
  },
  {
    ...
    calculate: (v) => {
      ...
      return [
        ...
        { label: "Tamaño de posición", value: num(Math.floor(risk / per)) },
      ];
    },
  },
  {
    ...
    fields: [
      f("portfolio", "Valor de cartera", 10000, "$"),
      f("current", "Peso actual", 70, "%"),
    ...
    calculate: (v) => {
      ...
      return [
        ...
        { label: "Comprar/vender", value: money(target - current) },
      ];
    },
  },
  {
  ...
  },
  {
    ...
    fields: [
      f("nominal", "Rentabilidad nominal", 10, "%"),
  ...
  },
  {
    ...
    fields: [
      f("a", "Capital final A", 12000, "$"),
      f("b", "Capital final B", 13500, "$"),
