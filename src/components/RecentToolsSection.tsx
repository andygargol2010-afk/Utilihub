  ...
  return (
    <section className="container-page pb-14" aria-labelledby="recent">
      <div className="flex items-end justify-between gap-4">
        <div>
          <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-[.16em] text-primary"><Clock3 className="size-3.5" /> Your activity</p>
          <h2 id="recent" className="mt-2 text-2xl font-extrabold sm:text-3xl">Recently used</h2>
          <p className="mt-2 text-sm text-muted-foreground">Quickly return to the tools you just used.</p>
        </div>
      </div>
