...
import { money } from "@/lib/financial/types";
  ...
  return <div className="space-y-6">
    <div className="grid gap-4 sm:grid-cols-2">
      {definition.fields.map((field) => <label key={field.key} className="space-y-2">
        ...
        <input type="number" inputMode="decimal" min={field.min} step={field.step ?? "any"} value={values[field.key]}
    ...
    {results.length > 0 && <div className="grid gap-3 sm:grid-cols-2">
