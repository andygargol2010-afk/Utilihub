...
const FORMULAS=new Set(["porcentaje","regla-de-tres","probabilidad","combinaciones","permutaciones","factorial","potencias-y-raices","logaritmos","notacion-cientifica","mcd-mcm","secuencias","bases-numericas"]);
