...
export function EducationTool({ tool }: { tool: GeneralTool }) {
  ...
  useEffect(() => {
    if (!challenge || mode !== "global" || !generated.length || completed || !deadlineRef.current) return;
